          ...
          <main>
            ...
            <article className={styles.flex_container} id={styles.article2}>
              <section id={styles.section2}>
                <p>主な活動は、4月に1年生対象のC言語の講習会や、オープンキャンパス・高専祭への出展、プログラミングコンテストへの参加・運営のお手伝いをしています。<br />例年、3年生の情報や電子で学ぶC言語を、1年生が約3週間でマスターしています。また、U-16プログラミングコンテストでは、例年1年生が全道大会へ進出しています。</p>
              </section>
